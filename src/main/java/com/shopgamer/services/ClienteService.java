...
public class ClienteService {
	...
	public void delete(Integer id) {
		...
		catch (DataIntegrityViolationExceptio e) {
			throw new DataIntegrityViolationExceptio("Não é possível excluir porque há pedidos relacionados");
		}
	}
	...
	public Cliente findByEmail(String email) {
		...
		if (obj == null) {
			throw new ObjectNotFoundExeception(
